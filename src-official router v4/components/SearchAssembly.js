...
export default class SearchAssembly extends Component {
  ...
  render() {
    ...
    return (
      <div style = {prepareStyles(styles.search)}>
        <SearchTypesSimple
          ref = 'searchTypes'
          value = {activeValue && activeValue.type? activeValue.type : null}
        ...
        <SearchBar
          ...
          value = {activeValue && activeValue.keywords? activeValue.keywords : null}
  ...
  handleOnSearch = (keywords)=>{
    ...
    this.props.history.push((searchPath.length > 0 ? searchPath : path) + `&size=${PAGE_SIZE}`);
  }
}
