  ...
  render() {
    ...
    return (
      <div style = {prepareStyles(styles.root)}>
        <div style = {prepareStyles(styles.contact)}>If you have any questions, please contact<a style = {prepareStyles(styles.email)} href="mailto:contact@e-ports.com"> contact@e-ports.com</a></div>
        <a
