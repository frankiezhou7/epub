...
export default class HomeContent extends Component {
      ...
      <div style={styles.desc.wrapper}>
        <div style={styles.desc.card}>
            ...
            <div style={styles.desc.intro}>
              Integrating and analyzing the information of ports in China, provide IT solutions and create value for shipping company of the whole world.
        ...
        <div style={styles.desc.card}>
            ...
            <div style={styles.desc.intro}>
              As an independent E-platform provides transparent price system for helping users to understand market price and the cost of each order item.
              <i style={styles.desc.line}></i>
            </div>
        </div>
        ...
        <div style={styles.desc.card}>
            ...
            <div style={styles.desc.intro}>
              The quality standardization of international shipping agency is the benchmark of E-PORTS, which supervise and control transactions in order to ensure business security, service quality.
              <i style={styles.desc.line}></i>
            </div>
        </div>
        <div style={styles.desc.card}>
            ...
            <div style={styles.desc.intro}>
              Real-time order status track,automatic quotes,financial analysis,file management online makes work more efficient, get cost saving and time saving.
            </div>
        </div>
      </div>
    );
  ...
  renderNewsRegulation = (styles) => {
    ...
    let news = this.state.hasNews ? _.map(home.news, (item, index) => {
    ...
    : (<div style={styles.news.noContent}>Sorry, No Latest News...</div>);

    let regulation = this.state.hasRegulation ? _.map(home.regulations, (item, index) => {
    ...
    : (<div style={styles.regulation.noContent}>Sorry, No Latest Regulations...</div>);
    ...
    return (
      <div style={styles.info}>
        ...
        <div style={styles.regulation.wrapper}>
          <div style={styles.title}>
            Regulation
            <a target ='_blank' href = {`/regulations`} style={_.assign({},styles.news.more,{right:0})}>More</a>
          </div>
            ...
            return (
              ...
              // >
                <div key={index} title={item.value.name} style={styles.partnership.item}>
                  ...
                  {(index + 1) % 5  === 0 || index === partnership.length - 1 ? <i style={_.assign({},styles.partnership.divider,{left: 'initial', right:-2})}/> : null}
                </div>
              // </a>
            );
          })}
  ...
  renderSlider = (styles) => {
    ...
    _.map(home.banners, (banner, index) => {
      return _.get(banner, ['value', 'link']) === '' ? (
        <div style={_.assign({},styles.resize, {backgroundImage:`url(${banner.value.img})`})} key={index}></div>
      ) : (
    ...
    _.map([1,2,3], (banner, index) => {
      return (
        <div style={_.assign({},styles.resize, {backgroundImage:`url(${require(`../../static/p${banner}-${size ? 990 : 1190}.jpg`)})`})} key={index}></div>
      );
    });
